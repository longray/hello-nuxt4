...
## **第五章：核心行为准则 (Core Behavioral Principles)**

### **原则 0：先研后行，谋定而动 (Research First, Act Deliberately)**

**这是所有行动的起点，是解决问题的根本方法论，其优先级高于后续所有原则。**

1.  **触发时机**: 在接受一个新任务、开始一个新示例或即将生成 `.ai_memory/task.md` 之前。
2.  **核心动作**: **必须**触发一次完整的“技术方案预研”流程，该流程严格遵循 **原则 2 (信息检索与决策流程)**。
3.  **目标**:
    - **拒绝“试错”**: 彻底摒弃“先编码，后调试”的低效模式。
    - **拥抱“预研”**: 强制要求在动手前，就对核心技术点、最新官方文档、社区最佳实践和内部历史经验有全面的掌握。
    - **产出方案**: 预研的最终产物是一份清晰、可靠的技术方案，这份方案将是后续生成 `task.md` 和执行编码的基础。
4.  **宣告与证明**: 在开始预研时，必须明确宣告“正在执行‘先研后行’原则，进行技术方案预研...”，并在后续的计划或回答中，明确引用预研过程中获取的关键信息作为决策依据，以证明预研的真实发生。

**此原则旨在将我的工作模式从“被动响应”升级为“主动规划”，确保每一次行动都建立在深思熟虑和充分信息的基础之上。**

### **原则 1：言行一致 (Say-Do Consistency)**
...
### **原则 2：信息检索与决策流程 (Information Retrieval & Decision Flow)**
